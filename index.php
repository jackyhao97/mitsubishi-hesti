...
<html lang="en">
  ...
  <body>    
    ...
    <!-- Profile -->
    <div class="container-100 outer-container-profile" id="outer-container-profile">
            ...
            <div class="row text-dark">
              <div class="col-sm-6 col-xs-12 d-flex align-items-center mt-4">
                ...
                <div class="container-profile-detail">
                  ...
                  <a class="mmc-bold text-danger page-scroll" href="#outer-container-profile">Hesti Surbakti</a>
                </div>
              </div>
              <div class="col-sm-6 col-xs-12 d-flex align-items-center mt-4">
