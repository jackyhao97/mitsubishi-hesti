...
<html lang="en">
  <head>
    ...
    <title>Mitsubishi New Xpander Medan - Hesti</title>
    <style>
  ...
  <body style="background:white;color:black">    
    ...
    <div class="container mt-5">
      ...
      <p class="text-center text-muted">Lihat harga terbaru New Xpander untuk wilayah Medan dan sekitarnya khusus untuk anda pengunjung website <a href="<?= BASE_URL; ?>" target="_blank">mitsubishihesti.xyz</a></p>
      ...
      <p class="text-black mt-2 mmc-bold">Untuk info detail harga lebih lanjut dapat menghubungi kami disini <a href="https://wa.me/+6282274190043?text=Halo Kak Hesti, Saya ingin bertanya lebih lanjut harga dari new xpander. (Sumber website mitsubishihesti.xyz)" class="text-success mmc-bold" target="_blank"><i class="fa fa-lg fa-whatsapp"></i> 0822-7419-0043</a></p>
    </div>
    <!-- Akhir Price -->
